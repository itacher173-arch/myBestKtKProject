...
TRAININGS = json.loads((ROOT / "services" / "training" / "catalog.json").read_text(encoding="utf-8"))
ARTICLES = json.loads((ROOT / "services" / "knowledge" / "seed.json").read_text(encoding="utf-8"))
