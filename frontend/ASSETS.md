...
Фактические снимки работающего прототипа для README хранятся отдельно в
`docs/assets/screenshots`; они не входят в frontend bundle и не копируются в
runtime Docker-образ.
