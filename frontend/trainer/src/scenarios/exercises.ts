import type { FaultType } from '../simulator/faultEngine'
import { EMERGENCY_ACTIONS } from '../simulator/faultEngine'
import type { Exercise } from '../simulator/types'
import { SPEC_SCENARIOS } from './catalog'
