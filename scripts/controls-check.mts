...
import { tickProcess } from '../src/sim/processModel'
import { sequenceBlockReason } from '../src/sim/scenarioGuards'
import { processInterlockReason } from '../src/sim/pazGuards'
import { CONTROLLABLE_EQUIP_IDS } from '../src/sim/controllable'
import { equipmentById } from '../src/scheme'
import {
  MINI_TRAININGS,
  evaluateMiniTraining,
} from '../src/miniTraining/catalog'
import { applyMiniPreset } from '../src/miniTraining/presets'
import {
  isMiniActionAllowed,
  pumpActionToken,
  valveActionToken,
...
const controlPanel = readFileSync(
  resolve('src/components/ControlPanel.tsx'),
  'utf8',
)
const inline = readFileSync(
  resolve('src/components/EquipInlineControls.tsx'),
  'utf8',
)
